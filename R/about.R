...
aboutUI <- function(id) {
  ...
  fluidPage(
    tabPanel(
      ...
      p("The Stations tab allows users to filter data by species, year, project and tag and visualize receiver locations. Project codes and descriptions can be found on the Ocean Tracking Network (OTN) website (the brown dots are PATH projects) https://members.oceantrack.org/OTN/projects"),
